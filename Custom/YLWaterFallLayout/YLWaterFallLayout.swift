//
//  YLWaterFallLayout.swift
//  YLWaterFallLayout
//
//  Created by ym on 2023/3/5.
//

import UIKit

@objc
protocol YLWaterFallLayoutDelegate: NSObjectProtocol {
    /// 根据给出的宽度计算出item高度
    func waterfallLayout(_ waterfallLayout: YLWaterFallLayout, heightForItemAtIndex index: Int, itemWidth: CGFloat) -> CGFloat

    /// cell的总列数
    @objc optional func colCountInWaterFlowLayout(_ waterfallLayout: YLWaterFallLayout) -> Int
    
    /// cell的列间距
    @objc optional func colMarginInWaterFlowLayout(_ waterfallLayout: YLWaterFallLayout) -> CGFloat
    
    /// cell的行间距
    @objc optional func rowMarginInWaterFlowLayout(_ waterfallLayout: YLWaterFallLayout) -> CGFloat
    
    /// collectionView的内容间距
    @objc optional func edgeInsetsInWaterFlowLayout(_ waterfallLayout: YLWaterFallLayout) -> UIEdgeInsets
}

@objcMembers
class YLWaterFallLayout: UICollectionViewLayout {
    // MARK: - 默认参数
    /// 默认列数
    ...
    // MARK: - 代理
    weak var delegate: (AnyObject & YLWaterFallLayoutDelegate)? = nil
...
private extension YLWaterFallLayout {
