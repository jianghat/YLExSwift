...
//        let label = UILabel.label(font: kHarmonyOSFont(16), textColor: .white)
//        return label
//    }()
    /// 保存按钮
...
extension YLRichTextView: WKUIDelegate,WKNavigationDelegate {
    /// 加载成功
...
//            browser.setupCoverViews([self.indexLabel,self.saveBtn]) { [weak self] (photoBrowser, superFrame) in
...
extension YLRichTextView: GKPhotoBrowserDelegate {
